...
public class VariableEx {
	...
	public static void main(String[] args) {
		...
		int order1 = 1 , order2 = 1 , order3 = 1, order4 = 1; //변수를 선언 후 초기값을 넣어주는 것이 좋습니다.
		//변수의 초기값은 숫자는 0, 블리언 false. 문자열은 "", char형은 0으로 초기화합니다
		order1 =2;
		order2 =1;
		order3 =6;
		order4 =1;
		...
		System.out.println("순대" + order2 + "인분 주문하여서 금액은" + res2 + "원입니다" );
		System.out.println("오뎅" + order3 + "개 주문하여서 금액은" + res3 + "원입니다" );
		System.out.println("김밥" + order4 + "인분 주문하여서 금액은" + res4 + "원입니다" );
